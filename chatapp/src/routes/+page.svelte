        ...
        <nav class="bg-gray-800">
            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="hidden md:block">
                    ...
                    <a href="#" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Game</a>

                    <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Chat</a>
            ...
            <div class="px-4 py-6 sm:px-0">
                ...
                <div class="relative mt-1 rounded-md shadow-sm">
                    ...
                    <input type="text" name="input" id="input" class="block w-full rounded-md border-gray-300 pl-7 pr-12" placeholder="type your command here">
                </div>
                </div>
            </div>
            <!-- /End replace -->
